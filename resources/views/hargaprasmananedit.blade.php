...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ url('/prasmanan') }}"></i>Harga Prasmanan</a></li>
      <li class="active">Ubah Harga Prasmanan</li>
    </ol>
</section>
...
<section class="content"> 
  ...
  <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">Ubah Harga Prasmanan</h3>
              </div>
              {!! Form::model($hargaprasmanan, ['url' => route('prasmanan.update', $hargaprasmanan->id), 'method' => 'put', 'files'=>'true', 'class'=>'form-horizontal']) !!}
